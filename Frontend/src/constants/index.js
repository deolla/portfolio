export const navLinks = [
  ...
  export const workExperiences = [
    {
      id: 1,
      name: 'Javascript & Python Development',
      pos: 'Web Developer',
      duration: '2022 - Present',
      title: "I specialize in JavaScript and Python development, creating dynamic, interactive web applications that engage users and deliver exceptional experiences. I use modern frameworks like React and Flask to build responsive, scalable solutions that meet client needs and exceed expectations.",
      icons: ['/assets/js.svg', '/assets/python.svg'],
      animation: 'victory',
    },
    {
      id: 2,
      ...
      pos: 'Web Developer',
      duration: '2020 - 2022',
      title: "Python is my go-to backend technology for building scalable, high-performance web applications. I use it to create APIs, handle requests, and manage data, ensuring a seamless user experience.",
    ...
    },
    {
      ...
      pos: 'Intern',
      duration: '2024- 2024',
      title: "NodeJs is my go-to backend technology for building scalable, high-performance web applications. I use it to create APIs, handle requests, and manage data, ensuring a seamless user experience.",
    ...
    },
    {
      ...
      pos: 'Web Application',
      duration: '2019 - 2020',
      title: "I have a strong foundation in HTML and CSS, which I use to create visually appealing, responsive web applications. I pay attention to detail, ensuring that every element is well-designed and functional.",
      icons: ['/assets/html.svg', '/assets/css.svg'],
      animation: 'victory',
    }
  ];